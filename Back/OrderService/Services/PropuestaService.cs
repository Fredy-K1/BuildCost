...
namespace OrderService.Services
{
    public class PropuestaService : IPropuestaService
    {
        ...
        public async Task<IEnumerable<PropuestaDto>> GetByContratistaIdAsync(Guid contratistaId)
        {
            var propuestas = await _repository.GetByContratistaIdAsync(contratistaId);
